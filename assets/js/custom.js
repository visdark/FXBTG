...
$('.nav-a').mouseenter(function() {
        $(this).closest('.nav').find('.nav-a').removeClass('active');
        $(this).addClass('active');
    });
jQuery(".focusbox").hover(function(){ jQuery(this).find(".prev,.next").stop(true,true).fadeTo("show",0.2) },function(){ jQuery(this).find(".prev,.next").fadeOut() });
jQuery(".focusbox").slide({ mainCell:".pic",effect:"topLoop", autoPlay:true, delayTime:600, trigger:"click"});
...
jQuery(".picList").slide({mainCell:".picli",autoPlay:true,effect:"leftMarquee",vis:4,interTime:50});
